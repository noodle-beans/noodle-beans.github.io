...
public class EditHtmlFiles
{
	public static void main( String[] args )
	{
		...
		for( int j = 1; j <= maxNumber; j++ )
		{
			...
			lines.set( 28, "		<p id=\"title\"><a name=\"comicView\">" + titles.get( j - 1 ) + "</a></p>" );
			lines.set( 29, "		<img id=\"comic\" src=\"../comics/comic" + String.format( "%04d", j ) + ".JPG\" width=\"400\" height=\"400\" alt=\"" + mouseOver.get( j - 1 ) + "\" title = \"" + mouseOver.get( j - 1 ) + "\">" );
			
			if( j == 1 )
			{
				lines.set( 31, " 			<li><a class=\"inactive\" href=\"javascript:;\">FIRST</a></li><!--" );
				lines.set( 32, " 			--><li><a class=\"inactive\" href=\"javascript:;\">PREV</a></li><!--" );
				lines.set( 33, " 			--><li><a href=\"0002.html#comicView\">NEXT</a></li><!--" );
			}
			else if( j == maxNumber )
			{
				lines.set( 32, " 			--><li><a href=\"" + String.format( "%04d", j - 1 ) + ".html#comicView\">PREV</a></li><!--" );
				lines.set( 33, " 			--><li><a class=\"inactive\" href=\"javascript:;\">NEXT</a></li><!--" );
				lines.set( 34, " 			--><li><a class=\"inactive\" href=\"javascript:;\">LAST</a></li>" );
			}
			else
			{
				lines.set( 31, " 			<li><a href=\"0001.html#comicView\">FIRST</a></li><!--" );
				lines.set( 32, " 			--><li><a href=\"" + String.format( "%04d", j - 1 ) + ".html#comicView\">PREV</a></li><!--" );
				lines.set( 33, " 			--><li><a href=\"" + String.format( "%04d", j + 1 ) + ".html#comicView\">NEXT</a></li><!--" );
				lines.set( 34, " 			--><li><a href=\"../index.html#comicView\">LAST</a></li>" );
			}
			
			lines.set( 36, "		<p id=\"description\">" + descriptions.get( j - 1 ) + "<p>" );
		...
		lines.set( 31, " 			<li><a href=\"noodles/0001.html#comicView\">FIRST</a></li><!--" );
		lines.set( 32, " 			--><li><a href=\"noodles/" + String.format( "%04d", maxNumber - 1 ) + ".html#comicView\">PREV</a></li><!--" );
		lines.set( 33, " 			--><li><a class=\"inactive\" href=\"javascript:;\">NEXT</a></li><!--" );
		lines.set( 34, " 			--><li><a class=\"inactive\" href=\"javascript:;\">LAST</a></li>" );
		lines.set( 36, "		<p id=\"description\">" + descriptions.get( maxNumber - 1 ) + "<p>" );
